...
for (int i = 0; i < n; i++) scanf("%lf", &grid[0][i]); // Top
for (int i = 0; i < n; i++) scanf("%lf", &grid[n - 1][i]); // Bottom
for (int i = 0; i < n; i++) scanf("%lf", &grid[i][0]); // Left
for (int i = 0; i < n; i++) scanf("%lf", &grid[i][n - 1]); // Right
